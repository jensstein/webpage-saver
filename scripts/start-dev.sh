...
podman create --pod $POD_ID --workdir /home/rust/source -e CARGO_HOME=/home/rust/cargo-home -v $PWD/cargo-home-dir:/home/rust/cargo-home:Z -v $PWD/backend:/home/rust/source:Z rust-dev cargo watch -w src -w db -w Cargo.toml -x "run --bin article_server_rs -- -p 5000 --db-path postgresql://$NAME:$NAME@127.0.0.1:5432/$NAME"
podman create --pod $POD_ID -e NEXT_TELEMETRY_DISABLED=1 -e BACKEND_URL=http://127.0.0.1:5000 -v $PWD/frontend/:/home/node/source:Z localhost/yarn yarn dev
